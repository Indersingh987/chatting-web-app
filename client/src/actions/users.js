...
export const getAllUsers = () => (dispatch) =>{
    ...
    axios.get('/api/users',{headers:{'Authorization':`Bearer ${JSON.parse(sessionStorage.getItem('token'))}`}})
    .then(res=>{
...
export const search = (searchQuery) => dispatch => {
    ...
    axios.post('/api/users/search',{ searchQuery },{headers:{'Authorization':`Bearer ${JSON.parse(sessionStorage.getItem('token'))}`}})
    .then(res=>{
...
export const cancle = (id,index) => dispatch => {
    ...
    axios.post('/api/request/cancle',{ id },{headers:{'Authorization':`Bearer ${JSON.parse(sessionStorage.getItem('token'))}`,'Content-Type':'application/x-www-form-urlencoded'}})
    .then(res=>{
...
export const request = (id,index) => dispatch => {
    ...
    axios.post('/api/request/send',{ id },{headers:{'Authorization':`Bearer ${JSON.parse(sessionStorage.getItem('token'))}`,'Content-Type':'application/x-www-form-urlencoded'}})
    .then(res=>{
